...
Complete_model_log <-lmer(log(AbsolutErrorR) ~ 1 + (1|StartPointID) + (1|SubjectID)  + Dwelling_Time_Building_Gaze+Dwelling_Time_Agent_Gaze + ContextEffectf*Agent_Action_levelf  + AgentPresencef + Matchf, data = df_Agent,  REML = FALSE)
qqmath(Complete_model_log)
```
