...
interceptOnly_Agent<-gls(AbsolutErrorR ~ 1, data = filtered_data, 
                    method = "ML")
...
TrialIDrandomIntercept_Agent <-lmer(AbsolutErrorR ~ 1 + (1|StartPointID) + (1|SubjectID), data = filtered_data)
